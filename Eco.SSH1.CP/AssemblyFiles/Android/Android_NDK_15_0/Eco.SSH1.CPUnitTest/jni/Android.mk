...
# prepare Eco.SSH1.CP
include $(CLEAR_VARS)
LOCAL_MODULE    := libC6AFCAA416674FCE89F30674A203EFE6
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../BuildFiles/Android/$(TARGET_ARCH_ABI)/StaticRelease/libC6AFCAA416674FCE89F30674A203EFE6.a 
include $(PREBUILT_STATIC_LIBRARY)
########################
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../UnitTestFiles/SourceFiles/EcoSSH1CP.c

ifeq ($(TARGET_LINK),0)

LOCAL_MODULE := EcoSSH1CPUnitTest
...
LOCAL_STATIC_LIBRARIES := 00000000000000000000000000000100 00000000000000000000000042757331 0000000000000000000000004D656D31 00000000000000000000000046534D31 C6AFCAA416674FCE89F30674A203EFE6
