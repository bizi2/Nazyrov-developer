...
int16_t EcoMain(IEcoUnknown* pIUnk) {
    ...
    IEcoASNOnePER1* pIEcoASNOnePER1 = 0;
    ...
    result = pIBus->pVTbl->RegisterComponent(pIBus, &CID_EcoASNOnePER1, (IEcoUnknown*)GetIEcoComponentFactoryPtr_4E050E5A92C6453F81466375F509D9E8);
    if (result != 0 ) {
        /* Free in case of an error */
        goto Release;
    }
    ...
    result = pIBus->pVTbl->QueryComponent(pIBus, &CID_EcoASNOnePER1, 0, &IID_IEcoASNOnePER1, (void**) &pIEcoASNOnePER1);
    if (result != 0 || pIEcoASNOnePER1 == 0) {
        /* Free interfaces in case of an error */
        goto Release;
    }


    result = pIEcoASNOnePER1->pVTbl->MyFunction(pIEcoASNOnePER1, name, &copyName);
...
Release:
    ...
    if (pIEcoASNOnePER1 != 0) {
        pIEcoASNOnePER1->pVTbl->Release(pIEcoASNOnePER1);
    }
