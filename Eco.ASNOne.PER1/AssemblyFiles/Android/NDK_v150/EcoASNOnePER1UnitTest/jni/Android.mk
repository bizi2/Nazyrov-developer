...
########################
# prepare Eco.ASNOne.PER1
include $(CLEAR_VARS)
LOCAL_MODULE    := lib4E050E5A92C6453F81466375F509D9E8
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../BuildFiles/Android/$(TARGET_ARCH_ABI)/StaticRelease/lib4E050E5A92C6453F81466375F509D9E8.a 
include $(PREBUILT_STATIC_LIBRARY)
########################

#
# EcoASNOnePER1UnitTest
#
include $(CLEAR_VARS)
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../UnitTestFiles/SourceFiles/EcoASNOnePER1.c

ifeq ($(TARGET_LINK),0)

LOCAL_MODULE := EcoASNOnePER1UnitTest
...
LOCAL_STATIC_LIBRARIES := 00000000000000000000000000000100 00000000000000000000000042757331 0000000000000000000000004D656D31 00000000000000000000000046534D31 4E050E5A92C6453F81466375F509D9E8
