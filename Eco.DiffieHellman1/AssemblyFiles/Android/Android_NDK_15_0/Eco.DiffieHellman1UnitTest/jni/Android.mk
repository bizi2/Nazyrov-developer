...
########################
# prepare Eco.DiffieHellman1
include $(CLEAR_VARS)
LOCAL_MODULE    := libE28A3709C7C642539BE15A46BFB8A295
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../BuildFiles/Android/$(TARGET_ARCH_ABI)/StaticRelease/libE28A3709C7C642539BE15A46BFB8A295.a 
include $(PREBUILT_STATIC_LIBRARY)
########################

#
# EcoDiffieHellman1UnitTest
#
include $(CLEAR_VARS)
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../UnitTestFiles/SourceFiles/EcoDiffieHellman1.c

ifeq ($(TARGET_LINK),0)

LOCAL_MODULE := EcoDiffieHellman1UnitTest
...
LOCAL_STATIC_LIBRARIES := 00000000000000000000000000000100 00000000000000000000000042757331 0000000000000000000000004D656D31 00000000000000000000000046534D31 E28A3709C7C642539BE15A46BFB8A295
