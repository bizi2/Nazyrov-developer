...
#ifndef __C_ECOPKCS8_FACTORY_H__
#define __C_ECOPKCS8_FACTORY_H__

#include "IEcoSystem1.h"

typedef struct CEcoPKCS8_A0A4CE6BFactory {
...
} CEcoPKCS8_A0A4CE6BFactory;

#endif /* __C_ECOPKCS8_FACTORY_H__ */
