...
int16_t EcoMain(IEcoUnknown* pIUnk) {
    ...
    result = pIBus->pVTbl->RegisterComponent(pIBus, &CID_EcoAES1, (IEcoUnknown*)GetIEcoComponentFactoryPtr_7C6C9BBB77724C6C9117540BE0872BD7);
    if (result != 0 ) {
        /* Освобождение в случае ошибки */
        goto Release;
    }
    ...
    result = pIBus->pVTbl->QueryComponent(pIBus, &CID_EcoAES1, 0, &IID_IEcoAES1, (void**) &pIEcoAES1);
